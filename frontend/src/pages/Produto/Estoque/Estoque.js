...
function Estoque() {
  ...
  const [produtoDetalhes, setProdutoDetalhes] = useState(null); // Para o modal de detalhes
  ...
  const handleViewMovements = () => {
    alert('Navegando para página de movimentações...');
    // Aqui você pode navegar para a rota de movimentações
